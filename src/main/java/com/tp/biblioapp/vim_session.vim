...
silent only
silent tabonly
cd ~/remote/biblioapp/src/main/java/com/tp/biblioapp
...
wincmd w
argglobal
if bufexists("Livre.java") | buffer Livre.java | else | edit Livre.java | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
wincmd w
argglobal
if bufexists("Emprunt.java") | buffer Emprunt.java | else | edit Emprunt.java | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
