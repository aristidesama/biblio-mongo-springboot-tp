...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 31 - ((15 * winheight(0) + 11) / 22)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
31
...
set stal=1
badd +0 Auteur.java
badd +0 DemoApplication.java
badd +0 AuteurRepository.java
badd +0 AuteurController.java
badd +0 ../../../../resources/application.properties
